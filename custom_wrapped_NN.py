...
def create_nn_classifier(input_dim, numb_classifiers = 2)-> KerasClassifier:
    # """
    # Creates a neural network classifier wrapped in SciKeras' KerasClassifier.
    # This allows the model to be used with Scikeras methods such as `fit`, `predict`,
    # `cross_val_score` and more.

    # Returns:
    #     KerasClassifier: A SciKeras wrapper around a Keras Sequential model
    #                     with two hidden layers (32 and 16 units), a softmax output layer,
    #                     and compiled for sparse categorical classification.
    # """
    """
