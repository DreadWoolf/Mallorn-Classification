...
def create_RNN_classifier(input_dim, numb_classifiers = 2)-> KerasClassifier:
    """
...
def build_model(input_dim, numb_classifiers):
        ...
        model = Sequential([
            ...
            # timesteps = 1
            tf.keras.Input(shape=(1, input_dim)),
            SimpleRNN(32, activation="tanh"),   # Elman network
            Dense(8, activation="relu"),        # light feature mixing
            Dense(numb_classifiers, activation="softmax")      # output
        ])
